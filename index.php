...
<html>
	<head>
		...
		<meta name="apple-mobile-web-app-title" content="JoeStrusz" />
					...
					<div id="main">
						...
						<!-- Contact -->
							<article id="contact">
								...
								<ul class="icons">
									<li><a target="new" href="https://www.facebook.com/joseph.strusz/" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li>
									<li><a target="new" href="https://www.instagram.com/joseph.strusz/" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
									<br /><br/><a target="" href="tel:+13056193868" class=""><span class="label">+1 (305) 619-3868</span></a>
								</ul>
							</article>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
								...
								<section>
									...
									<ul class="icons">
										...
										<li><a href="https://www.facebook.com/joestrusz/" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li>
										<li><a href="https://www.instagram.com/joestrusz/" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
										<li><a href="https://www.github.com/u/joestrusz/" class="icon brands fa-github"><span class="label">Github</span></a></li>
									</ul>
